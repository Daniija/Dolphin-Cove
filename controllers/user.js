...
exports.postCategory = (req, res, next) => {
   ...
   connectDB.query(data, (err, result) => {
      if (err) throw err; //show if error found
         ...
         //console.log(result);
         return res.render('user/showCategory', { user: req.session.mail, events: result })
      }
   })
...
exports.postBooking = (req, res, next) => {
   ...
   res.render('user/bookingConfirm', { user: req.session.mail, name: req.body.name, type: req.body.type, cost: req.body.cost });
}
